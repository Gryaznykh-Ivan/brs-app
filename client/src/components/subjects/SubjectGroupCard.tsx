...
export default function SubjectGroupCard({ id, subjectId, studentCount, isDeletable, buttons, onDelete }: IProps) {
    ...
    return (
        <div className="flex bg-white rounded-lg p-2 shadow-sm">
            <Link to={`/subjects/${subjectId}/${id}`} className="flex flex-1">
